                    ...
                    <div class="p-3 m-3">
                      <div class="row g-3">
                        <form class="text-center" action="<?php echo htmlspecialchars($_SERVER["REQUEST_URI"]); ?>" method="POST">
                          ...
                          <div>
                            <button type="submit" class="btn btn-lg btn-success bg-gradient mt-3 mb-1" name="submit" id="submit">Search</button>
                          </div>
                        </form>
                          <div>
                        ...
                        <form class="text-center" action="editReservation.php" method="POST">
                          <div>
                            <input type="hidden" class="d-none" id="Reservation_ID" name="Reservation_ID" value="<?php echo $Reservation_ID; ?>" hidden>
                          </div>
                          <div>
                            <input type="hidden" class="d-none" id="Status" name="Status" value="<?php echo $Status; ?>" hidden>
                          </div>
                          <div>
                            <input type="hidden" class="d-none" id="Customer_First_Name" name="Customer_First_Name" value="<?php echo $Customer_First_Name; ?>" hidden>
                          </div>
                          <div>
                            <input type="hidden" class="d-none" id="Customer_Last_Name" name="Customer_Last_Name" value="<?php echo $Customer_Last_Name; ?>" hidden>
                          </div>
                          <div>
                            <input type="hidden" class="d-none" id="Number_Of_Guests" name="Number_Of_Guests" value="<?php echo $Number_Of_Guests; ?>" hidden>
                          </div>
                          <div>
                            <input type="hidden" class="d-none" id="Customer_Phone" name="Customer_Phone" value="<?php echo $Customer_Phone; ?>" hidden>
                          </div>
                          <div>
                            <input type="hidden" class="d-none" id="Reservation_Date" name="Reservation_Date" value="<?php echo $Reservation_Date; ?>" hidden>
                          </div>
                          <div>
                            <input type="hidden" class="d-none" id="Reservation_Time" name="Reservation_Time" value="<?php echo $Reservation_Time; ?>" hidden>
                          </div>
                          <div>
                            <input type="hidden" class="d-none" id="Submitted_Reservation" name="Submitted_Reservation" value="<?php echo $Submitted_Reservation; ?>" hidden>
                          </div>
                          <div>
                            <?php
                            if ($Reservation_ID > 0)
                            {
                              echo '<button type="submit" class="btn btn-lg btn-success bg-gradient mt-3 mb-1" name="submit" id="submit">Edit</button>';
                            }
                            ?>
                          </div>
                        </form>
