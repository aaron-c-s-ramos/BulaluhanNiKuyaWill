...
<html lang="EN">
    ...
    <?php
                                        ...
                                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            echo
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-success bg-gradient"><a href="update.php?updateID=' . $Reservation_ID . '" class="text-decoration-none text-light">Update</a></button></td>
                                                    <td><button class="btn btn-danger bg-gradient"><a href="delete.php?deleteID=' . $Reservation_ID . '" class="text-decoration-none text-light">Delete</a></button></td>
                                                </tr>';
                                        }
                                        ?>
                                    </tbody>
                ...
                <footer class="py-4 bg-light bg-gradient mt-auto">
                    <div class="container-fluid px-4">
